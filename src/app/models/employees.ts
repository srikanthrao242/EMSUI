...
export const EmployeeColumnsDesc: EmployeeColumnsSchema[] = [
  ...
  {name: 'dateOfRelieving', label: 'Date Of Relieving', type: 'date', validators:['', Validators.required]},
  {name: 'email', label: 'Contact Email', type:'string', validators:['', Validators.required, Validators.email]},
  {name: 'mobile', label: 'Contact Mobile', type:'String', validators:['',Validators.required, Validators.min(13)]},
